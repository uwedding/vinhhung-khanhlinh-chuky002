...
const GOOGLE_SCRIPT_URL_THAM_DU =
  "https://script.google.com/macros/s/AKfycbzMEw5sXk1kBzRvhMa02r_ItpghkywRYeKqOQPnZbVMa3lQqgIxTjfEeos5h4AI1YXJlg/exec";
document
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (target === "bride") {
    ...
    if (target === "bride") {
        const img51 = document.getElementById("IMAGE51");
        const img52 = document.getElementById("IMAGE52");

        const temp = img51.src;
        img51.src = img52.src;
        img52.src = temp;
    }
});
